...
<body>
	...
	<div class="content-box">
		...
		<div class="content-title">회계 관리 | 은행 계좌 관리 | 상세 정보</div>
		<table>
			<thead>
				<tr>
					<th>계좌명</th>
		...
		<div class="btn-group">
			<button class="btn green"
				onclick="location.href='${pageContext.request.contextPath}/bankmgUpdateForm.do?bankId=${bankmg.bankId}'">수정</button>
