...
<nav class="side">
    <ul>
        ...
        <li><a href="productionStockIn.do"><i class="fas fa-plug"></i> 회계 관리</a></li>
        <li><a href="productionStockIn.do"><i class="fas fa-plug"></i> 차량 관리</a></li>
        <li><a href="productionStockIn.do"><i class="fas fa-plug"></i> 그룹 웨어</a></li>
        <li><a href="main.do"><i class="fas fa-home"></i> Homepage</a></li>
        <li><a href="productionStockIn.do"><i class="fas fa-sign-out-alt"></i> 로그아웃</a></li>
    </ul>
</nav>
