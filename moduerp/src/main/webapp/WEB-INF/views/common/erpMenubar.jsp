...
<body>
	...
	<nav class="side">
		<ul>
        	...
        	--%>
			<li><a href="<c:url value='/empMgt.do' />"><i
					class="fas fa-users-cog"></i> 인사 관리</a></li>
			<li><a href="<c:url value='/productionStockIn.do' />"><i
					class="fas fa-industry"></i> 생산 관리</a></li>
			<li><a href="<c:url value='/purchaseOrders.do' />"><i
