...
<body>
	...
	<div class="content-box">
		...
		<!-- 필터 박스 -->
		<form action="/moduerp/carmgtFilter.do">
		...
		<table>
			...
			<tbody>
				<c:forEach var="carmgt" items="${carmgtList}">
					<tr
						onclick="window.location.href='getCarmgtDetail.do?paymentHistoryCode=${ carmgt.paymentHistoryCode }' ">
						...
						<td><fmt:formatDate value="${carmgt.paymentDate}"
